...
## Release Strategy
バージョンは**メジャー.マイナー.パッチ**のように三つの数字で採番します。

破壊的な仕様変更を行った際はメジャーバージョンアップとし、それ以外はマイナーとパッチバージョンアップとします。

メジャーバージョンアップが行われた際は、大幅なコード変更が必要になる可能性があるため、バージョンアップには注意して下さい。（というか大幅に変更したい部分があるため、事前に注意歓呼しておきます。）
