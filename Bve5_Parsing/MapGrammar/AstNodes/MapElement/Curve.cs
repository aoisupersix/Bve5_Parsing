...
namespace Bve5_Parsing.MapGrammar.AstNodes.Curve
{
    /*
     * CurveのAST木定義
     */
    ...
    public class SetFunctionNode : Syntax_1
    {
        public override void Init(AstContext context, ParseTreeNode treeNode)
        {
            ...
            AddArguments("id", nodes, 2, typeof(double));
        }
    }
    ...
    public class BeginNode : Syntax_1
    {
        public override void Init(AstContext context, ParseTreeNode treeNode)
        {
            ...
            //引数の登録
            AddArguments("radius", nodes, 2, typeof(double));
            if (nodes.Count > 3)
                AddArguments("cant", nodes, 3, typeof(double));
        }
    }
